package com.taylorthingx.TestMod;

import com.taylorthingx.TestMod.block.ModBlockEntities;
import com.taylorthingx.TestMod.block.ModBlocks;
...
public class TestMod
{
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> TEST_TAB = CREATIVE_MODE_TABS.register("test_tab", () -> CreativeModeTab.builder()
            ...
            .icon(() -> ModItems.TEST_ITEM.get().getDefaultInstance())
            .displayItems((parameters, output) -> {
                output.accept(ModItems.TEST_ITEM.get()); // Add the example item to the tab. For your own tabs, this method is preferred over the event
            }).build());
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS)
            event.accept(ModBlocks.TEST_BLOCK_ITEM);
    }
